...
<body>
	...
	<div id="content">
		<h2 style="color: red; position: absolute; right: 39%; top: 20%;">Incorrect
			login or password!</h2>
		<div id="login">
			<form action="<c:url value="/user/list"/>" method="post"
				...
				<div class="control-group">
					<div class="controls">
						...
						<a href="<c:url value="/user/registr"/>" class="btn btn-primary"
							style="width: 120px">Registration</a>
					</div>
				</div>
